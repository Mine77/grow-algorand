        ...
        <div className="flex flex-row items-center">
          <div className="flex flex-col items-start justify-center w-1/2 h-full pr-8 mb-10">
            <h1 className="text-6xl font-extrabold tracking-tight text-gray-900">
              ...
              <span className="inline text-transparent bg-clip-text bg-gradient-to-br from-blue-600 to-blue-500">Resources</span>
            </h1>
            ...
            <div className="flex flex-row">
              <a
                href="#"
                className="flex items-center px-10 py-3 mb-3 text-lg text-white bg-blue-600 rounded-md w-auto hover:bg-blue-500"
              >
                Explore
              </a>
            </div>
